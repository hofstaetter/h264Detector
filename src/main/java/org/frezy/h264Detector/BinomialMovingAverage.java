...
public class BinomialMovingAverage implements Observer {
    ...
    public BinomialMovingAverage(Stream stream) {
        this.stream = stream;
    ...
    public BinomialMovingAverage(Stream stream, int size) {
        this.stream = stream;
    ...
    public BinomialMovingAverage(Stream stream, int size, int bufferSize) {
        this.stream = stream;
        this.tempBuffer = new long[size];
